...
describe('git.js module', () => {
  ...
  describe('pr object', () => {
    describe('create()', () => {
      it('creates a pull request with the specified parameters', async () => {
        execa.mockResolvedValueOnce({stdout: 'https://github.com/owner/repo/pull/1'});
      ...
      it('logs error when PR creation fails', async () => {
