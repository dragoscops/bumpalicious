...
import conventionalchangelogAtom from 'conventional-changelog-atom';
import conventionalchangelogCodemirror from 'conventional-changelog-codemirror';
import conventionalchangelogConventionalcommits from 'conventional-changelog-conventionalcommits';
import conventionalchangelogEmber from 'conventional-changelog-ember';
import conventionalchangelogEslint from 'conventional-changelog-eslint';
import conventionalchangelogExpress from 'conventional-changelog-express';
import conventionalchangelogJquery from 'conventional-changelog-jquery';
import conventionalchangelogJshint from 'conventional-changelog-jshint';
...
export class ChangelogService extends Loggable {
  ...
  async generateForWorkspace(options: GenerateChangelogOptions): Promise<ChangelogResult> {
    ...
    try {
      // Load the preset configuration using static imports
      let createPreset: () => Promise<any>; // eslint-disable-line @typescript-eslint/no-explicit-any

      switch (preset) {
        case 'conventionalcommits':
          createPreset = conventionalchangelogConventionalcommits;
          break;
        case 'angular':
          createPreset = conventionalchangelogAngular;
          break;
        case 'atom':
          createPreset = conventionalchangelogAtom;
          break;
        case 'codemirror':
          createPreset = conventionalchangelogCodemirror;
          break;
        case 'ember':
          createPreset = conventionalchangelogEmber;
          break;
        case 'eslint':
          createPreset = conventionalchangelogEslint;
          break;
        case 'express':
          createPreset = conventionalchangelogExpress;
          break;
        case 'jquery':
          createPreset = conventionalchangelogJquery;
          break;
        case 'jshint':
          createPreset = conventionalchangelogJshint;
          break;
        default:
