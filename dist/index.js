...
const ChangelogService_js_1 = require("./core/ChangelogService.js");
const VersionService_js_1 = require("./core/VersionService.js");
...
async function run() {
    try {
        ...
        const versionService = new VersionService_js_1.VersionService();
